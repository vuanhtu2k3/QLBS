...
namespace GUI.Pages
{
    public partial class frmTacGia : Form
    {
        ...
        {
            dgvTacGia.DataSource = TheLoaiBLL.SelectALL();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    TheLoaiBLL.Delete(dgvTacGia.SelectedRows[0].Cells["clMaLoai"].Value.ToString());
        ...
        private void dgvTheLoai_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                LoadUI(TheLoaiBLL.Select(dgvTacGia.SelectedRows[0].Cells["clMaLoai"].Value.ToString()));
            }
            catch
            {
                ResetControl();
        ...
        {
            lblTong.Text = string.Format("Tổng: {0} thể loại", dgvTacGia.Rows.Count);
        }
