...
namespace GUI.Pages
{
    public partial class frmNXB : Form
    {
        ...
        {
            dgvNXB.DataSource = TheLoaiBLL.SelectALL();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    TheLoaiBLL.Delete(dgvNXB.SelectedRows[0].Cells["clMaLoai"].Value.ToString());
        ...
        private void dgvTheLoai_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                LoadUI(TheLoaiBLL.Select(dgvNXB.SelectedRows[0].Cells["clMaLoai"].Value.ToString()));
            }
            catch
            {
                ResetControl();
        ...
        {
            lblTong.Text = string.Format("Tổng: {0} thể loại", dgvNXB.Rows.Count);
        }
